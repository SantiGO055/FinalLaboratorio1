...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void* computers))
{
 ...
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
char ll_map(LinkedList* this, char* (*pFunc)(void* ,void*))
{
    eCadenas* pCadenas;
    Node* pNodeA;
    Node* pNodeB;
    Node* pNodeAux;
    int i,func,j,strcmpaux;
    char* prueba;
    int listSize = ll_len(this);
    if(this != NULL)
    {
        /*for(i = 0; i < ll_len(this);i++)
        {
            pCadenas = ll_get(this, i);
            //pCadenas=pFunc(pCadenas);
            //prueba=pFunc((void*)pCadenas->cadenas, (void*)pCadenas->cadenas);
        }*/
                ...
                for(j = i+1; j < listSize;j++)
                {
                    ...
                    pNodeB = getNode(this, j);
                        ...
                        if(func == 1)
                        {
                            ...
                            //ll_sort(this, eCadenas_sort,1);
                            //strcmpaux=eCadenas_sort(pNodeA->pElement,pNodeB->pElement);


                            //controller_sortCadenas(this,1);

                        //eCadenas_showeCadenas(this);
